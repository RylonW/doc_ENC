...
def main():
    ...
    parser.add_argument('--opt', type=str, default='./options/train/train_Enhance_MSEC.yml',
    ...
    # # # #
        ...
        if opt['datasets'].get('val', None) and epoch % opt['train']['val_epoch'] == 0:
            ...
            for val_data in val_loader:
                ...
                util.custom_save_img('/home/eescut/Desktop/doc_ENC/output/experiments/STEN/val_images/',en_img,epoch,'restore',idx)
                util.custom_save_img('/home/eescut/Desktop/doc_ENC/output/experiments/STEN/val_images/',gt_img,epoch,'gt',idx)
                ############################
